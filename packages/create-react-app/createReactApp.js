...
const program = new commander.Command(packageJson.name)
  ...
  .on('--help', () => {
    ...
    console.log(
      `      ${chalk.cyan(
        'https://github.com/entryone/create-react-app/issues/new'
      )}`
    );
    console.log();
  })
...
function install(root, useYarn, dependencies, verbose, isOnline) {
  return new Promise((resolve, reject) => {
    ...
    if (useYarn) {
      ...
      // https://github.com/entryone/create-react-app/issues/3326.
...
// https://github.com/entryone/create-react-app/pull/368#issuecomment-243446094
